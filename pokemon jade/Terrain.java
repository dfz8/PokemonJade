//David Zhao, 5/17/2011
   ...
   /*
   	...
   	-for each gate, put down where it is located, which map it links to, and its destination row and column on that map
   	...
   	-look at mapPart1, mapPart2, and mapPart3 for an example of how to break up a map into smaller chunks
   ...
   */
      ...
      {
         g.drawImage(myImage.getImage(), x*23 - GameScreen.SPRITE_WIDTH/2 , y*26 - GameScreen.SPRITE_HEIGHT/2, null);
      }	
   }